...
/*
 * The wiz-shiz case: both branches reorganised the same sprite folder under different names,
 * so git reports a conflict on files whose contents are byte-identical. Reproduced here
 * because the resulting UI was actively misleading — it counted "0" conflicts on a row it
 * would not let you dismiss, and offered a choice between two identical things without ever
 * saying they were identical.
 */
